...
//			uploadHeadPhoto();
		...
		case R.id.rl_nickname:
			...
			Log.e(TAG,"nick = "+SuperWeChatApplication.getInstance().currentUserNick);
				...
				.execute(new OkHttpUtils2.OnCompleteListener<String>() {
					...
					public void onSuccess(String s) {
						...
						if(result!=null && result.isRetMsg()){
							...
							Toast.makeText(UserProfileActivity.this,getString(R.string.toast_updatenick_success),Toast.LENGTH_LONG).show();
							dialog.dismiss();
						}
					}
					@Override
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == OnSetAvatarListener.REQUEST_CROP_PHOTO) {
			Log.e(TAG,"update avatar to app server...");
